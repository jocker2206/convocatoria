                ...
                <List.Content>
                    ...
                    <List.Content>
                        <div className="row">
                            ...
                            <div className="col-md-12 mt-1">
                                <b className="text-muted">
                                    <i className="fas fa-building"></i> Dependencia/Oficina:
                                </b>
                            </div>
                            <div className="col-md-12 mt-1">
                                <b className="text-muted">
                                    <i className="fas fa-briefcase"></i> Perfil Laboral
                                </b>
                            </div>
                            <div className="col-md-12 mt-1">
                                <b className="text-muted">
                                    <i className="fas fa-coins"></i> Honorarios:
                                </b>
                            </div>
                        </div>
                    </List.Content>
